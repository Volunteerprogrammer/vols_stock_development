...
class FormComponent  extends \fw\view\form\FormComponent{
    ...
    public $trashicon   = '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 22 22"><path d="M9,3V4H4V6H5V19A2,2 0 0,0 7,21H17A2,2 0 0,0 19,19V6H20V4H15V3H9M7,6H17V19H7V6M9,8V17H11V8H9M13,8V17H15V8H13Z" /></svg>';
    public $bookinghistoryicon   = '<svg xmlns="http://www.w3.org/2000/svg" width="28" height="28"  viewBox="0 0 24 24"><path d="M4,2A2,2 0 0,0 2,4V14H4V4H14V2H4M8,6A2,2 0 0,0 6,8V18H8V8H18V6H8M20,12V20H12V12H20M20,10H12A2,2 0 0,0 10,12V20A2,2 0 0,0 12,22H20A2,2 0 0,0 22,20V12A2,2 0 0,0 20,10M19,17H17V19H15V17H13V15H15V13H17V15H19V17Z" /></svg>';
    public $righticon = '<svg xmlns="http://www.w3.org/2000/svg" width="35" height="35" viewBox="0 0 24 24"><path d="M19,3H5A2,2 0 0,0 3,5V19C3,20.11 3.9,21 5,21H19C20.11,21 21,20.11 21,19V5A2,2 0 0,0 19,3M19,19H5V5H19V19M8.29,16.59L12.88,12L8.29,7.41L9.71,6L15.71,12L9.71,18L8.29,16.59Z" /></svg>';
    public $doublerighticon   = '<svg xmlns="http://www.w3.org/2000/svg" width="35" height="35" viewBox="0 0 24 24"><path d="M19,3 H5A2, 2 0 0, 0 3,5 V19A2, 2 0 0, 0 5,21H19A2, 2 0 0, 0 21,19V5A2,2 0 0,0 19,3M19,19H5V5H19V19M6.29,7.41L10.88,12L6.29,16.59L7.71,18L13.71,12 L7.71,6L6.29,7.4ZM10.29,7.41L14.88,12L10.29,16.59L11.71,18 L17.71,12 L11.71,6 L10.29,7.41 Z"/></svg>';
    public $lefticon      = '<svg xmlns="http://www.w3.org/2000/svg"  width="35" height="35" viewBox="0 0 24 24"><path d="M19,3H5A2,2 0 0,0 3,5V19A2, 2 0 0, 0 5,21H19A2, 2 0 0, 0 21,19V5A2,2 0 0,0 19,3M19,19H5V5H19V19M15.71,7.41L11.12,12L15.71,16.59L14.29,18L8.29,12L14.29,6L15.71,7.41Z" /></svg>';
    public $doublelefticon   = '<svg xmlns="http://www.w3.org/2000/svg" width="35" height="35" viewBox="0 0 24 24"><path d="M19,3 H5A2, 2 0 0, 0 3,5 V19A2, 2 0 0, 0 5,21H19A2, 2 0 0, 0 21,19V5A2,2 0 0,0 19,3M19,19H5V5H19V19M17.71,7.41L13.12,12L17.71,16.59L16.29,18L10.29,12L16.29,6L17.71,7.41ZM13.71,7.41L9.12,12L13.71,16.59L12.29,18L6.29,12L12.29,6L13.71,7.41Z" /></svg>';
    ...
    public $todayicon   = '<svg xmlns="http://www.w3.org/2000/svg" width="72" height="35"  viewBox="0 0 49 24"><path d="M44,3 H5 A2, 2 0 0, 0 3,5 V19A2, 2 0 0, 0 5,21H44A2, 2 0 0, 0 46,19V5A2,2 0 0,0 44,3 M44,19H5V5H44V19"/><text x="25" y="16" text-anchor="middle" font-family="Arial, sans-serif" font-size="12" font-weight="700"  fill="black">today</text></svg>';
