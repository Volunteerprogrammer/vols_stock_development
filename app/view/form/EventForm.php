...
class EventForm extends \fw\view\form\StdCRUDForm {
    ...
    public function buildinputs($rights=[],$trace=false) {
        ...
        $formfields .= $this->component->buildinputrow("groupindex",27,"",'Group position','',3,3,true,'','The position of this Event in its Event Group (1,2,...).');
        ...
        $formfields .= $this->component->buildinputrow("sessiondepth",29,"",'Session per page','',3,3,true,'','This determines how many sessions will be displayed for the parent event per roster page?');
        ...
        $formfields .= '<div id="weeklyrecurrence" class="periodic-ocurrence">';
            ...
            $windex = "<div id='weeklyindexwrapper' class='vols-float-left'><select name='weeklyindex' id='weeklyindex' class='vols-form-select hide' size='1' required='' data-fnum='30' disabled=''></select></div>"; // only used if weekly interval > 1, populated by JS $onloadscript (see below)
    ...
    public function formscript() {
        ...
        $postloadfieldsscript = <<<JS
                        ...
                        displayweeklyindex(jfield[10],jfield[30]);
         JS;
